...
class UserManager(BaseUserManager):
    ...
    def create_user(self, user_id, first_name=None, last_name=None, avatar_url=None, password=None):
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    first_name = models.CharField(max_length=255, default=False, blank=True)
    last_name = models.CharField(max_length=255, default=False, blank=True)
    is_active = models.BooleanField(default=True, blank=True)
    is_staff = models.BooleanField(default=False)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    avatar_url = models.CharField(max_length=455, default=False, blank=True)
